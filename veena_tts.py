...
# Quantization config: 4-bit with nf4 + bfloat16 compute
...
# Load quantized model with auto device placement (CPU+GPU if available)
...
# Main function to generate speech audio from text
...
# SNAC token decoding into waveform
